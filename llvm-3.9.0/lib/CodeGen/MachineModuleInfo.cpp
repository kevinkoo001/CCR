...
//===----------------------------------------------------------------------===//
// Koo - Added MCObjectFileInfo* at MachineModuleInfo constructor to store JT Info
MachineModuleInfo::MachineModuleInfo(const MCAsmInfo &MAI,
                                     const MCRegisterInfo &MRI,
                                     const MCObjectFileInfo *MOFI)
  : ImmutablePass(ID), Context(&MAI, &MRI, MOFI, nullptr, false), MOFI(MOFI) { // Koo
  initializeMachineModuleInfoPass(*PassRegistry::getPassRegistry());
}

MachineModuleInfo::MachineModuleInfo()
  : ImmutablePass(ID), Context(nullptr, nullptr, nullptr), MOFI(nullptr) { // Koo
